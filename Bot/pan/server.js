// スプレッドシートキー
// CP管理用
const CP_SPREADSHEET_KEY = "134akcwyboCpd1dgJaoeA_dtcGMT5Ql9iWmlyi6rhTSs";
// 出欠管理用
const AD_SPREADSHEET_KEY = "13U2_Mh_StD-nnAESjaAJsjQbBadglRuQ3Xyy5ldySZU";

// イベント告知用WebhookURL
// 本番
// https://discord.com/api/webhooks/777830614019604500/cpYwqIHN3K40ENvW_uc2tLLxaVQbYXgLhpF08IvjMNRkc84APtpDJSr_2NdvwP0ixH4U
const discordhookid = "777830614019604500";
const discordhooktoken = "cpYwqIHN3K40ENvW_uc2tLLxaVQbYXgLhpF08IvjMNRkc84APtpDJSr_2NdvwP0ixH4U";
    ...
    if (0 === msg.content.indexOf("イベント登録\n")) {
      ...
      */
      ...
      if (false === updated) {
        ...
        await msg.channel.createMessage("イベント情報の更新は手動で行って下さい。\nhttps://docs.google.com/spreadsheets/d/13U2_Mh_StD-nnAESjaAJsjQbBadglRuQ3Xyy5ldySZU/edit?usp=sharing\n[イベントRef]シートを編集して下さい。");
      }
      return;
    }
        ...
        if (null != colname) {
          ...
          if (vcokCountData.value != (vcokReactions.length + vcngReactions.length - 2)
            ...
            try {
              ...
              const meesage = await bot.executeWebhook(
                '777749056444563498',
                'AsSsuW3T2DNTJ163dRwAmSKvD0ZIx3JKPQZzZ7238Ux5M23-bpIb5anN2S1yix558usa',
